...
### Pairing
Switch on your device. Now switch off and on within 2 seconds. Repeat off/on four times. Reset is done when the device is switched on in the fifth time and the light stays on after blinking 4 times. It should fade now in changing colors and stop if pairing was sucessfull.
